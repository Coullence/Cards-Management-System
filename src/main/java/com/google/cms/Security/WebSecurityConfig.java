package com.google.cms.Security;

import com.google.cms.Security.jwt.AuthEntryPointJwt;
import com.google.cms.Security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
				...
				.authorizeRequests().antMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**").permitAll().and()  // Allowing access to Swagger UI and API docs
